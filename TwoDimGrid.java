...
public class TwoDimGrid extends JPanel implements GridColors {
     ...
     */
    public TwoDimGrid(final int nRows, final int nCols) {
        this.nRows = nRows;
        this.nCols = nCols;
     ...
     */
    public void recolor(final int x, final int y, final Color newColor) {
     ...
     */
    public void recolor(final char[][] bitMap, final Color aColor) {
     ...
     */
    public void recolor(final Color tempColor, final Color newColor) {
    ...
    private class ToggleColor implements ActionListener {
         ...
         */
        public ToggleColor(final JButton theButton) {
            me = theButton;
        }
